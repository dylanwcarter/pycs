function PredictCard({ date, modelType, fileName, predictedYield }) {
  return (
    <div className="bg-black border-2 border-gray-200 p-5 text-gray-200 m-2.5 rounded-none inline-block flex-shrink-0">
      ...
      <button className="bg-black text-white rounded-lg text-sm px-2 py-1 mt-2 border border-gray-800 hover:bg-gray-800 transition">
        View Plot
      </button>
    </div>
  );
